    ...
    if (randnum == 7){
     ...
     break;
      ...
      if (bdx-5<=xc && bdx>=xc-85){
        ...
        if (downdir){
          int randir =rand()%7;
          upperright(xc,yc,r,randir,color,4+downpower/200);
          break;
        }
        else{
          upperright(xc,yc,r,randnum,color,4+downpower/200);
          break;}
      }
      else
      {
 ...
 while (1){
   ...
   break;
    ...
    uppower = 0;
      if (downdir){
        int randir =rand()%7;
        upperleft(xc,yc,r,randir,color,4+downpower/200);
        break;
        }
      else{
        upperleft(xc,yc,r,randnum,color,4+downpower/200);}
        break;
      }
      else
      {
    ...
    if (randnum == 7){
     ...
     break;
      ...
      if (bux-5<=xc && bux>=xc-85){
        ...
        if (updir){
          int randir =rand()%7;
          downright(xc,yc,r,randir,color,4+uppower/200);
          break;
          }
        else{
          downright(xc,yc,r,randnum,color,4+uppower/200);
          break;}
        }
      else
      {
   ...
   if (xc >= radius && yc>=radius+10){
    ...
    if (randnum == 7){
     ...
     break;
      ...
      if (updir){
        int randir =rand()%7;
        downleft(xc,yc,r,randir,color,4+uppower/200);
        break;
        }
      else{
        downleft(xc,yc,r,randnum,color,4+uppower/200);
        break;}
      }
      else
      {
...
void TIM3_IRQHandler(void)
{
 ...
 if (TIM3->SR & 1<<0){//if update interrupt pending
  ...
  if ((temp>>5)&0x01){
    if (start==1 && uppower<1000){
        uppower += 1;
      if (uppower<=200 && uppower>0){
          EIE3810_TFTLCD_FillRectangle(400,30,100,uppower/10,RED);}
      else if (uppower<=400 && uppower>200){
          EIE3810_TFTLCD_FillRectangle(400,30,120,(uppower-200)/10,YELLOW);}
      else if (uppower<=600 && uppower>400){
          EIE3810_TFTLCD_FillRectangle(400,30,140,(uppower-400)/10,GREEN);}
      else if (uppower<=800 && uppower>600){
          EIE3810_TFTLCD_FillRectangle(400,30,160,(uppower-600)/10,BLUE);}
      else if (uppower<=1000 && uppower>800){
          EIE3810_TFTLCD_FillRectangle(400,30,180,(uppower-800)/10,BLACK);
       EIE3810_TFTLCD_ShowChar2412(385,200,'B',RED,WHITE);
      EIE3810_TFTLCD_ShowChar2412(400,200,'O',RED,WHITE);
      EIE3810_TFTLCD_ShowChar2412(415,200,'O',RED,WHITE);
      EIE3810_TFTLCD_ShowChar2412(430,200,'M',RED,WHITE);
   };
    }
  }
  if ((temp>>4)&0x01){
  ...
  if (readKey1() == 0x0000){
    if (start==1 && downpower<1000){
      downpower += 1;
      if (downpower<=200 && downpower>0){
        EIE3810_TFTLCD_FillRectangle(400,30,700-downpower/10,1,RED);}
      else if (downpower<=400 && downpower>200){
        EIE3810_TFTLCD_FillRectangle(400,30,700-downpower/10,1,YELLOW);}
      else if (downpower<=600 && downpower>400){
        EIE3810_TFTLCD_FillRectangle(400,30,700-downpower/10,1,GREEN);}
      else if (downpower<=800 && downpower>600){
        EIE3810_TFTLCD_FillRectangle(400,30,700-downpower/10,1,BLUE);}
      else if (downpower<=1000 && downpower>800){
        EIE3810_TFTLCD_FillRectangle(400,30,700-downpower/10,1,BLACK);
     EIE3810_TFTLCD_ShowChar2412(385,720,'B',RED,WHITE);
    EIE3810_TFTLCD_ShowChar2412(400,720,'O',RED,WHITE);
    EIE3810_TFTLCD_ShowChar2412(415,720,'O',RED,WHITE);
    EIE3810_TFTLCD_ShowChar2412(430,720,'M',RED,WHITE);
   }
      }
  }
...
void TIM4_IRQHandler(void)
{
 ...
 if (count == 10){
  ...
  if (start==1){
    if (downpower==0){
      EIE3810_TFTLCD_FillRectangle(380,60,600,160,WHITE);
    }
    if (uppower==0){
      EIE3810_TFTLCD_FillRectangle(380,60,100,160,WHITE);
    }
  }
 }
