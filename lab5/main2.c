...
void EIE3810_TIM4_Init(u16 arr, u16 psc)
{
 ...
 NVIC->IP[30]=0x45;//set the priority of TIM3 interrupt to 0100
...
void TIM3_IRQHandler(void)
{
 ...
 {
  GPIOB->ODR ^=1<<5;//toggle LED 0 by XOR a 1s
 }
 TIM3->SR &= ~(1<<0);//get rid of the pending
}
void TIM4_IRQHandler(void)
{
 if (TIM4->SR & 1<<0)//if update interrupt pending
 {
  GPIOE->ODR ^=1<<5;//toggle LED1 by XOR a 1
 }
